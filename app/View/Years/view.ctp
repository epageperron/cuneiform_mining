...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Year', true), array('action' => 'edit', $year['Year']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Year', true), array('action' => 'delete', $year['Year']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $year['Year']['id'])); ?> </li>
