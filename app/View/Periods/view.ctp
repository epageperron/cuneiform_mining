...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Period', true), array('action' => 'edit', $period['Period']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Period', true), array('action' => 'delete', $period['Period']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $period['Period']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($period['Tablet'] as $tablet):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
