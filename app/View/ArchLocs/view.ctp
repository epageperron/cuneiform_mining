<div class="archLocs view">
<h2><?php  __('Arch Loc');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $archLoc['ArchLoc']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Arch Loc'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $archLoc['ArchLoc']['arch_loc']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Arch Loc Desc'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $archLoc['ArchLoc']['arch_loc_desc']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Arch Loc', true), array('action' => 'edit', $archLoc['ArchLoc']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Arch Loc', true), array('action' => 'delete', $archLoc['ArchLoc']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $archLoc['ArchLoc']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($archLoc['Tablet'] as $tablet):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
