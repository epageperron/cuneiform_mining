<div class="actions index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $action['Action']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $action['Action']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $action['Action']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $action['Action']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
