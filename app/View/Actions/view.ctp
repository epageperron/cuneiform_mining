...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Action', true), array('action' => 'edit', $action['Action']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Action', true), array('action' => 'delete', $action['Action']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $action['Action']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Actions', true), array('action' => 'index')); ?> </li>
...
<th class="actions"><?php __('Actions');?></th>
	...
	<?php
	$i = 0;
	foreach ($action['Tablet'] as $tablet):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
